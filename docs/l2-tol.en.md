...
- `Native` — Parachain base token governed by first-order referenda at L1 level
...
### 3.3 L1 TOL DAO Voting Advantage
...
`Phase note`: The framework operates as a progressive L2 TOL factory — basic features launch first, advanced governance models are added via upgrades.
...
| Governance | `veto_override_threshold` | `50%`        |
