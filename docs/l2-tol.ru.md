...
- `Реализация стресс-пола`: Моделируемое поведение стресс-пола (огибающая `P_stress`) может расходиться с наблюдаемыми спотовыми рыночными ценами (`P_xyk`) при стрессовых условиях ликвидности
