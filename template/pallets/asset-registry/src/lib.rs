...
pub mod pallet {
  ...
  use polkadot_sdk::sp_runtime::traits::{Convert, MaybeEquivalence, StaticLookup};
  use polkadot_sdk::staging_xcm::latest::Location;
  use primitives::assets::{CurrencyMetadata, MASK_TYPE, TYPE_FOREIGN};

  // Specific traits not in prelude
  use polkadot_sdk::frame_support::traits::{fungibles::Inspect, EnsureOrigin, Get};
  ...
  #[pallet::config]
  pub trait Config:
    polkadot_sdk::frame_system::Config + polkadot_sdk::pallet_assets::Config
  {
      ...
      From<<T as polkadot_sdk::pallet_assets::Config>::AssetId> + Copy,
  {
    ...
    pub fn register_foreign_asset(
      ...
      if pallet_assets::Pallet::<T>::asset_exists(asset_id.clone()) {
      ...
      pallet_assets::Pallet::<T>::force_create(
        polkadot_sdk::frame_system::RawOrigin::Root.into(),
    ...
    pub fn link_existing_asset(
      ...
      // 5. Emit Event (Reuse registration event as the outcome is the same: mapping created)
