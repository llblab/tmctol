...
mod benches {
  ...
  fn process_fees() {
    ...
    #[extrinsic_call]
    process_fees(RawOrigin::Signed(caller));
  }
  ...
  fn process_foreign_fees() {
    ...
    T::BenchmarkHelper::ensure_funded(&caller, native, liquidity_amount.saturated_into())
      .expect("Failed to fund caller");
    T::BenchmarkHelper::ensure_funded(&caller, asset, liquidity_amount.saturated_into())
      .expect("Failed to fund caller");
    ...
    let fee_amount: u128 = 1_000_000_000_000; // 1 unit
