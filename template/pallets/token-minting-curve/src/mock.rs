...
impl pallet_token_minting_curve::TolZapInterface<u128> for MockTolZapAdapter {
  ...
  fn add_to_zap_buffer(_token_asset: AssetKind, _total_native: u128, _total_foreign: u128) {}
}
...
impl pallet_token_minting_curve::Config for Test {
  ...
  type UserAllocationRatio = RatioStub;
  type ZapAllocationRatio = RatioStub;
  type BurnPercentage = RatioStub;
