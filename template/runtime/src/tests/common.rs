...
use crate::{
  configs::AssetKind, AccountId, AssetConversion, Assets, Balance, Balances, Runtime,
...
use primitives::assets::{TYPE_FOREIGN, TYPE_LP, TYPE_STD};
...
// LP Tokens (0x4...)
#[allow(dead_code)]
pub const LP_ASSET_A: u32 = TYPE_LP | 1;
#[allow(dead_code)]
pub const LP_ASSET_B: u32 = TYPE_LP | 2;
#[allow(dead_code)]
pub const LP_ASSET_D: u32 = TYPE_LP | 3;
#[allow(dead_code)]
pub const LP_ASSET_E: u32 = TYPE_LP | 4;
#[allow(dead_code)]
pub const LP_ASSET_FOREIGN: u32 = TYPE_LP | 5;
