...
use super::common::{
  setup_axial_router_infrastructure, setup_basic_test_environment, ALICE, ASSET_A, BOB, CHARLIE,
  DAVE, EVE, INITIAL_BALANCE, SWAP_AMOUNT,
};
...
fn test_multi_user_concurrent_chaos() {
  ...
  ext.execute_with(|| {
    ...
    // 2. Setup basic infrastructure using common helper
    assert_ok!(setup_axial_router_infrastructure());
